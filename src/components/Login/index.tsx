        ...
        <>
            ...
            <div className="main">
                ...
                <form className="main__form" action="">
                    ...
                    <input className="main__email--input" type="email" name="" id="" placeholder="exemplo@email.com"/>
                    ...
                    <div className="main__password__sub-block">
                        <input className="main__password--input" type="password" name="" id="" placeholder="Digite sua senha"/>
                        <input type="checkbox" className="main__password--hide-checkbox" id="hide_cb" checked={true}/>
                        <label className="main__password--label" htmlFor="hide_cb">
                            <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 12C1 12 5.36364 3 13 3C20.6364 3 25 12 25 12C25 12 20.6364 21 13 21C5.36364 21 1 12 1 12Z" stroke="#425DC7" stroke-width="1.5"/>
                                <path d="M13 15.3745C14.8075 15.3745 16.2727 13.8635 16.2727 11.9995C16.2727 10.1356 14.8075 8.62451 13 8.62451C11.1925 8.62451 9.72729 10.1356 9.72729 11.9995C9.72729 13.8635 11.1925 15.3745 13 15.3745Z" stroke="#142159" stroke-width="1.5"/>
                            </svg>                        
                        </label>
                    ...
                    <div className="main__sub-block">
                        <div className="main__checkbox__block">
                            <input className="main__checkbox__input" type="checkbox"/>
